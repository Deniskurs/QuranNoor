...
final class NamesOfAllahService {
    ...
    /// Get names filtered by category
    func getNames(for category: NamesCategory) -> [NameOfAllah] {
        guard category != .all else { return getAllNames() }
        return allNames.filter { $0.category == category }
            .sorted { $0.number < $1.number }
    }
    ...
    private static func createNamesDatabase() -> [NameOfAllah] {
        return [
            // 1-10
            NameOfAllah(number: 1, arabicName: "الرَّحْمَنُ", transliteration: "Ar-Rahman", translation: "The Most Merciful", meaning: "The One who has plenty of mercy for the believers and the disbelievers in this world and especially for the believers in the hereafter.", benefit: "Recite 100 times after Fajr prayer for opening the heart to Allah's mercy.", category: .mercy),

            NameOfAllah(number: 2, arabicName: "الرَّحِيمُ", transliteration: "Ar-Rahim", translation: "The Most Compassionate", meaning: "The One who has plenty of mercy for the believers.", benefit: "Recite 100 times for mercy in all affairs.", category: .mercy),

            NameOfAllah(number: 3, arabicName: "الْمَلِكُ", transliteration: "Al-Malik", translation: "The King", meaning: "The One with the complete Dominion, the One whose Dominion is clear from imperfection.", benefit: "Recite 100 times for respect and honor.", category: .power),

            NameOfAllah(number: 4, arabicName: "الْقُدُّوسُ", transliteration: "Al-Quddus", translation: "The Most Holy", meaning: "The One who is pure from any imperfection and clear from children and adversaries.", benefit: "Recite frequently for purification of the heart.", category: .perfection),

            NameOfAllah(number: 5, arabicName: "السَّلاَمُ", transliteration: "As-Salam", translation: "The Source of Peace", meaning: "The One who is free from every imperfection.", benefit: "Recite for peace of mind and heart.", category: .perfection),

            NameOfAllah(number: 6, arabicName: "الْمُؤْمِنُ", transliteration: "Al-Mu'min", translation: "The Granter of Security", meaning: "The One who witnessed for Himself that no one is God but Him, and witnessed for His believers that they are truthful in their belief that no one is God but Him.", benefit: "Recite for safety and security.", category: .perfection),

            NameOfAllah(number: 7, arabicName: "الْمُهَيْمِنُ", transliteration: "Al-Muhaymin", translation: "The Guardian", meaning: "The One who witnesses the saying and deeds of His creatures.", benefit: "Recite for divine protection.", category: .perfection),

            NameOfAllah(number: 8, arabicName: "الْعَزِيزُ", transliteration: "Al-Aziz", translation: "The Almighty", meaning: "The Defeater who is not defeated.", benefit: "Recite 41 times daily for strength and honor.", category: .power),

            NameOfAllah(number: 9, arabicName: "الْجَبَّارُ", transliteration: "Al-Jabbar", translation: "The Compeller", meaning: "The One that nothing happens in His Dominion except that which He willed.", benefit: "Recite for overcoming difficulties.", category: .power),

            NameOfAllah(number: 10, arabicName: "الْمُتَكَبِّرُ", transliteration: "Al-Mutakabbir", translation: "The Supreme", meaning: "The One who is clear from the attributes of the creatures and from resembling them.", benefit: "Recite for self-purification from arrogance.", category: .power),

            // 11-20
            NameOfAllah(number: 11, arabicName: "الْخَالِقُ", transliteration: "Al-Khaliq", translation: "The Creator", meaning: "The One who brings everything from non-existence to existence.", benefit: "Recite for creativity and innovation.", category: .perfection),

            NameOfAllah(number: 12, arabicName: "الْبَارِئُ", transliteration: "Al-Bari", translation: "The Evolver", meaning: "The Maker of the soul.", benefit: "Recite for relief from grief.", category: .perfection),

            NameOfAllah(number: 13, arabicName: "الْمُصَوِّرُ", transliteration: "Al-Musawwir", translation: "The Fashioner", meaning: "The One who forms His creatures in different pictures.", benefit: "Recite during pregnancy for a healthy child.", category: .perfection),

            NameOfAllah(number: 14, arabicName: "الْغَفَّارُ", transliteration: "Al-Ghaffar", translation: "The Oft-Forgiving", meaning: "The Forgiver of sins again and again.", benefit: "Recite after each prayer for forgiveness.", category: .mercy),

            NameOfAllah(number: 15, arabicName: "الْقَهَّارُ", transliteration: "Al-Qahhar", translation: "The Subduer", meaning: "The Dominant One who has the perfect Power and is not unable over anything.", benefit: "Recite for victory over enemies.", category: .power),
            ...
            NameOfAllah(number: 19, arabicName: "اَلْعَلِيْمُ", transliteration: "Al-Alim", translation: "The All-Knowing", meaning: "The One who knows everything.", benefit: "Recite for increase in knowledge.", category: .knowledge),
            ...
            NameOfAllah(number: 26, arabicName: "السَّمِيعُ", transliteration: "As-Sami", translation: "The All-Hearing", meaning: "The One who hears all voices and sounds.", benefit: "Recite for acceptance of prayers.", category: .knowledge),

            NameOfAllah(number: 27, arabicName: "الْبَصِيرُ", transliteration: "Al-Basir", translation: "The All-Seeing", meaning: "The One who sees all that is seen.", benefit: "Recite for spiritual vision.", category: .knowledge),

            NameOfAllah(number: 28, arabicName: "الْحَكَمُ", transliteration: "Al-Hakam", translation: "The Judge", meaning: "The One who judges between His servants.", benefit: "Recite for justice in matters.", category: .knowledge),
            ...
            NameOfAllah(number: 30, arabicName: "اللَّطِيفُ", transliteration: "Al-Latif", translation: "The Subtle One", meaning: "The One who is kind to His slaves and endows upon them.", benefit: "Recite for gentleness in affairs.", category: .mercy),

            // 31-40
            NameOfAllah(number: 31, arabicName: "الْخَبِيرُ", transliteration: "Al-Khabir", translation: "The All-Aware", meaning: "The One who knows the truth of things.", benefit: "Recite for awareness of truth.", category: .knowledge),

            NameOfAllah(number: 32, arabicName: "الْحَلِيمُ", transliteration: "Al-Halim", translation: "The Forbearing", meaning: "The One who delays the punishment for those who deserve it.", benefit: "Recite for patience and tolerance.", category: .mercy),
            ...
            NameOfAllah(number: 34, arabicName: "الْغَفُورُ", transliteration: "Al-Ghafur", translation: "The Great Forgiver", meaning: "The One who forgives the sins of His slaves.", benefit: "Recite constantly for forgiveness.", category: .mercy),
            ...
            NameOfAllah(number: 43, arabicName: "الرَّقِيبُ", transliteration: "Ar-Raqib", translation: "The Watchful", meaning: "The One that nothing is absent from Him.", benefit: "Recite for awareness of Allah's watch.", category: .knowledge),
            ...
            NameOfAllah(number: 46, arabicName: "الْحَكِيمُ", transliteration: "Al-Hakim", translation: "The Wise", meaning: "The One who is correct in His doings.", benefit: "Recite 100 times for wisdom.", category: .knowledge),

            NameOfAllah(number: 47, arabicName: "الْوَدُودُ", transliteration: "Al-Wadud", translation: "The Loving", meaning: "The One who loves His believing slaves.", benefit: "Recite for love between people.", category: .mercy),
            ...
            NameOfAllah(number: 50, arabicName: "الشَّهِيدُ", transliteration: "Ash-Shahid", translation: "The Witness", meaning: "The One from whom nothing is absent.", benefit: "Recite for truthfulness.", category: .knowledge),

            // 51-60
            NameOfAllah(number: 51, arabicName: "الْحَقُّ", transliteration: "Al-Haqq", translation: "The Truth", meaning: "The One who truly exists.", benefit: "Recite for guidance to truth.", category: .knowledge),
            ...
            NameOfAllah(number: 53, arabicName: "الْقَوِيُّ", transliteration: "Al-Qawiyy", translation: "The Strong", meaning: "The One with the complete Power.", benefit: "Recite for strength.", category: .power),

            NameOfAllah(number: 54, arabicName: "الْمَتِينُ", transliteration: "Al-Matin", translation: "The Firm", meaning: "The One with extreme Power which is un-interrupted and He does not get tired.", benefit: "Recite for steadfastness.", category: .power),
            ...
            NameOfAllah(number: 57, arabicName: "الْمُحْصِي", transliteration: "Al-Muhsi", translation: "The Reckoner", meaning: "The One who the count of things are known to Him.", benefit: "Recite for accountability.", category: .knowledge),
            ...
            NameOfAllah(number: 62, arabicName: "الْحَيُّ", transliteration: "Al-Hayy", translation: "The Ever-Living", meaning: "The One attributed with a life that is unlike our life and is not that of a combination of soul, flesh or blood.", benefit: "Recite for spiritual life.", category: .perfection),

            NameOfAllah(number: 63, arabicName: "الْقَيُّومُ", transliteration: "Al-Qayyum", translation: "The Self-Subsisting", meaning: "The One who remains and does not end.", benefit: "Recite with Al-Hayy for spiritual awakening.", category: .perfection),
            ...
            NameOfAllah(number: 69, arabicName: "الْقَادِرُ", transliteration: "Al-Qadir", translation: "The Capable", meaning: "The One attributed with Power.", benefit: "Recite for capability.", category: .power),

            NameOfAllah(number: 70, arabicName: "الْمُقْتَدِرُ", transliteration: "Al-Muqtadir", translation: "The Powerful", meaning: "The One with the perfect Power that nothing is withheld from Him.", benefit: "Recite for overcoming obstacles.", category: .power),
            ...
            NameOfAllah(number: 79, arabicName: "الْبَرُّ", transliteration: "Al-Barr", translation: "The Source of Goodness", meaning: "The One who is kind to His creatures.", benefit: "Recite for goodness.", category: .mercy),

            NameOfAllah(number: 80, arabicName: "التَّوَابُ", transliteration: "At-Tawwab", translation: "The Acceptor of Repentance", meaning: "The One who grants repentance to whoever He willed.", benefit: "Recite 360 times for acceptance of repentance.", category: .mercy),

            // 81-90
            NameOfAllah(number: 81, arabicName: "الْمُنْتَقِمُ", transliteration: "Al-Muntaqim", translation: "The Avenger", meaning: "The One who victoriously prevails over His enemies.", benefit: "Recite for justice against oppressors.", category: .power),

            NameOfAllah(number: 82, arabicName: "العَفُوُّ", transliteration: "Al-Afuww", translation: "The Pardoner", meaning: "The One with wide forgiveness.", benefit: "Recite constantly for pardon.", category: .mercy),

            NameOfAllah(number: 83, arabicName: "الرَّؤُوفُ", transliteration: "Ar-Ra'uf", translation: "The Most Kind", meaning: "The One with extreme Mercy.", benefit: "Recite for kindness.", category: .mercy),
            ...
            NameOfAllah(number: 93, arabicName: "النُّورُ", transliteration: "An-Nur", translation: "The Light", meaning: "The One who guides.", benefit: "Recite for enlightenment.", category: .perfection),
            ...
            NameOfAllah(number: 95, arabicName: "الْبَدِيعُ", transliteration: "Al-Badi'", translation: "The Incomparable", meaning: "The One who created the creation without any precedent.", benefit: "Recite for uniqueness.", category: .perfection),
